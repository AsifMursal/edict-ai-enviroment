...
def edict_video(url):
    ...
    final_clip.write_videofile("videos/news_edicted_7.mp4")

    upload_video("news_edicted_7.mp4")
    
    return("videos/news_edicted_7.mp4")

# edict_video("https://www.hindustantimes.com/cities/pune-news/artificial-lights-wrapped-around-trees-harm-flora-and-fauna-demand-for-strict-action-in-pune-lightpollution-treeconservation-pune-101681755794877.html")